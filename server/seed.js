  ...
  auto({
    ...
    users: ['remove', (done, callback) => {
      User.create({
        ...
        username: 'jason@greenpioneersolutions',
        password: 'truetrue1!',
        roles: ['admin'],
        profile: {
        ...
        username: 'accounting@greenpioneersolutions',
        password: 'truetrue1!',
        profile: {
        ...
        username: 'ceo@greenpioneersolutions',
        password: 'truetrue1!',
        profile: {
        ...
        username: 'development@greenpioneersolutions',
        password: 'truetrue1!',
        profile: {
        ...
        username: 'qa@greenpioneersolutions',
        password: 'truetrue1!',
        profile: {
        ...
        username: 'help@greenpioneersolutions',
        password: 'truetrue1!',
        profile: {
    ...
    blogs: ['users', (results, callback) => {
      Blog.create({
        ...
        title: 'vision',
        content: 'We believe in the vision of sustainable computing. We stand out= require(the crowd because our focus is on green computing – a concept that many companies and organizations do not pay enough attention to.',
        ...
        title: 'Sustainable',
        content: 'Sustainable or green computing involves the best-known practices of designing, manufacturing, using, and disposing of anything= require(computers to servers and even subsystems.',

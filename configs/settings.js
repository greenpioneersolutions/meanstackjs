...
module.exports = function (env) {
  ...
  var settings
  var settingsENV = env || process.env.NODE_ENV
  if (settingsENV === 'test') {
    settings = _.merge(baseLine, require('./environments/test.js'))
  } else if (settingsENV === 'production') {
    settings = _.merge(baseLine, require('./environments/production.js'))
  } else if (settingsENV === 'nightwatch') {
    settings = _.merge(baseLine, require('./environments/nightwatch.js'))
  } else {
